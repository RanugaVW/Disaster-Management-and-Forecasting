...
print("--- Training Flood Model with Optuna Hyperparameter Optimization ---")
train_df = pd.read_csv('Datasets/flood_train.csv')
val_df = pd.read_csv('Datasets/flood_val.csv')

X_train = train_df[['temp', 'hum', 'depth_prev', 'depth']]
y_train = train_df['label']

X_val = val_df[['temp', 'hum', 'depth_prev', 'depth']]
y_val = val_df['label']
...
joblib.dump(ensemble_model, 'Models/flood_ensemble_model.pkl')
